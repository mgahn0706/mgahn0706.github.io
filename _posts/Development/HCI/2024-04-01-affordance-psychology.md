...
[[Affordance(어포던스)|Affordance(어포던스)]] 글에서 알 수 있듯이, 어포던스는 '물체가 할 수 있는 것'이어서 사람이 물체를 지각하고 인식해야 의미있는 개념이기 때문입니다. 이런 어포던스는 비단 UI/UX 에서만 사용되지 않습니다. 이번에는 어포던스라는 개념을 지각심리학 측면에서 이해해보고자 합니다.
...
---
  ...
  예를 들면,
  ![[/assets/img/posts/Pasted image 20240331202352.png|/assets/img/posts/Pasted image 20240331202352.png]]
